...
exe "hi! Comment"     ." cterm=italic,bold"
...
" Make some groups italic and bold to increase readability
" This is the tvacme part
exe "hi! Statement" ." gui=italic" ." cterm=italic"
exe "hi! Constant" ." gui=bold" ." cterm=italic"
exe "hi! Identifier" ." gui=bold" ." cterm=bold"
exe "hi! Type" ." gui=bold" ." cterm=bold"
exe "hi! PreProc" ." gui=bold" ." cterm=bold"
"}}}
